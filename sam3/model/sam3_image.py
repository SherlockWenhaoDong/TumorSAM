...
from .tsa import TemporalSpatialAdapter
...
class Sam3Image(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.tsa = TemporalSpatialAdapter(dim=self.hidden_dim)
    ...
    def forward_grounding(
        ...
        with torch.profiler.record_function("SAM3Image._run_encoder"):
            ...
            # ✅ ====== ADD TSA HERE ======
            memory = encoder_out["encoder_hidden_states"]  # [HW, B, C]
            x = memory.permute(1, 0, 2)
            x = self.tsa(x)
